...
PathCls.graph_sample_path(
    ...
    title='Survival curve without therapy',
...
Figs.graph_histogram(
    ...
    title='Estimated survival time without anticoagulation therapy',
...
SupportMarkov.print_outcomes(simOutputs, 'Without anticoagulation therapy:')
